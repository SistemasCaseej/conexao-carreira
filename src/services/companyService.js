...
export async function createCompanyService(address, businessSector, city, cnpj, companySize, legalName, logo, site, tradeName, users = []) {
    return await companyRepository.createCompanyRepository(address, businessSector, city, cnpj, companySize, legalName, logo, site, tradeName, users);
}
