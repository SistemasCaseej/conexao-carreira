...
export async function POST(request) {
    ...
    const companyId = await createCompanyService("Avenida Aluizio da Silva Gomes, 50 - Bairro da Gloria, Macae - RJ, 27.930-560", null, "Macaé", "26.676.739/0001-01", null, "Case Empresa Junior", null, null, "Case Empresa Junior");
